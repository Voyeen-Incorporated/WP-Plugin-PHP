...
function _give_show_test_mode_notice_in_admin_bar( $wp_admin_bar ) {
	...
	$wp_admin_bar->add_menu(
		[
			...
			'title'  => __( 'Best Donation Test Mode Active', 'give' ),
			'meta'   => [
...
function give_license_notices() {
	...
	$notice_description = sprintf(
		_n(
			'Your Best Donation add-on is not receiving critical updates and new features because you have %1$s license key. Please <a href="%2$s" title="%3$s">activate your license</a> to receive updates and <a href="%4$s" target="_blank" title="%5$s">priority support</a>',
			'Your Best Donation add-ons are not receiving critical updates and new features because you have %1$s license keys. Please <a href="%2$s" title="%3$s">activate your license</a> to receive updates and <a href="%4$s" target="_blank" title="%5$s">priority support</a>',
