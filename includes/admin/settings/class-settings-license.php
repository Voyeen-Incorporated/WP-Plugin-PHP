						...
						<div id="give-license-activator-wrap" class="give-license-top-widget">
							<div id="give-license-activator-inner">
								...
								<p class="give-field-description">
									<?php
									printf(
										__( 'Enter your license key below to unlock your Best Donation add-ons. You can access your licenses anytime from the <a href="#" target="_blank">My Account</a> section on the Best Donation website. ', 'give' ),
							...
							<div id="give-addon-uploader-inner">
								...
								<?php if ( ! is_multisite() ) : ?>
									...
									<p class="give-field-description">
										<?php
										printf(
											__( 'Drag an add-on zip file below to upload and activate it. Access your downloads by activating a license or via the <a href="#" target="_blank">My Downloads</a> section on the Best Donation website. ', 'give' ),
									...
									<?php if ( 'direct' !== get_filesystem_method() ) : ?>
										<div class="give-notice notice notice-error inline">
											<p>
												<?php
												echo sprintf(
													__( 'Sorry, you can not upload plugin from here because we do not have direct access to file system. Please <a href="#" target="_blank">click here</a> to upload Best Donation Add-on.', 'give' ),
									...
									<?php
										...
										printf(
											__( 'Because of security reasons you can not upload add-ons from here. Please <a href="#" target="_blank">visit network plugin install page</a> to install add-ons.', 'give' ),
						...
						<div class="give-licenses-list-header give-clearfix">
							...
							<div id="give-refresh-button-wrap">
								<button id="give-button__refresh-licenses"
									...
									<?php echo $is_allow_refresh ? '' : sprintf( 'title="#"', $button_title ); ?>>
									<?php _e( 'Refresh All Licenses', 'give' ); ?>
								</button>
								<span id="give-last-refresh-notice">
									<?php
									echo sprintf(
										__( 'Last refreshed on # at %2$s', 'give' ),
