				...
				case 'post-types':
					$settings = [
						...
						[
							...
							'desc'    => __( 'The sidebar allows you to add additional widgets to the Best Donation single form view. If you don\'t plan on using the sidebar you may disable it with this option.', 'give' ),
							'id'      => 'form_sidebar',
							'type'    => 'radio_inline',
							'default' => 'enabled',
							'options' => [
				...
				case 'taxonomies':
					$settings = [
						...
						[
							...
							'desc'    => __( 'Enable Categories for all Best Donation forms.', 'give' ),
							'id'      => 'categories',
							'type'    => 'radio_inline',
							'default' => 'disabled',
							'options' => [
						...
						[
							...
							'desc'    => __( 'Enable Tags for all Best Donation forms.', 'give' ),
							'id'      => 'tags',
							'type'    => 'radio_inline',
							'default' => 'disabled',
							'options' => [
