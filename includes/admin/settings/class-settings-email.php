                ...
                <tr valign="top" <?php echo ! empty( $field['wrapper_class'] ) ? 'class="' . $field['wrapper_class'] . '"' : ''; ?>>
                    ...
                    <td class="give-forminp">
                        <div class="give-field-description">
                            <?php _e( 'Best Donation recommends SendWP to ensure quick and reliable delivery of all emails sent from your site, such as donation receipts, recurring donation renewal reminders, password resets, and more.', 'give' ); ?> <?php printf( __( '%sLearn more%s', 'give' ), '<a href="#" target="_blank" rel="noopener noreferrer">', '</a>' ); ?>
                        </div>
			...
			switch ( $current_section ) {
				case 'email-settings':
					$settings = array(
						...
						array(
							...
							'desc'    => esc_html__( 'The name which appears in the "From" field in all Best Donation donation emails.', 'give' ),
						...
						array(
							...
							'desc'    => esc_html__( 'Email address from which all Best Donation emails are sent from. This will act as the "from" and "reply-to" email address.', 'give' ),
				...
				case 'donor-email':
					$settings = array(
						...
						array(
							'desc'       => __( 'Email notifications sent from Best Donation for donor are listed below. Click on an email to configure it.', 'give' ),
							'type'       => 'title',
				...
				case 'admin-email':
					$settings = array(
						...
						array(
							'desc'       => __( 'Email notifications sent from Best Donation for admin are listed below. Click on an email to configure it.', 'give' ),
							'type'       => 'title',
