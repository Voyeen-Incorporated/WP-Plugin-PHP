				...
				case 'offline-donations':
					$settings = [
						...
						[
							...
							'desc'    => __( 'If enabled, required billing address fields are added to Offline Donation forms. These fields are not required to process the transaction, but you may have a need to collect the data. Billing address details are added to both the donation and donor record in Best Donation. ', 'give' ),
						...
						[
							...
							'url'   => esc_url( 'http://Best Donation.com/offlinegateway' ),
				...
				case 'gateways-settings':
					$settings = [
						...
						[
							...
							'url'   => esc_url( 'http://Best Donation.com/settings-gateways' ),
