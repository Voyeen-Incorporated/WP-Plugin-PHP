					...
					'fields'    => apply_filters(
						...
						[
							...
							[
								...
								'type'  => 'docs_link',
								'url'   => 'http://docs.Best Donation.com/form-donation-options',
								'title' => __( 'Donation Options', 'give' ),
							],
						],
						$post_id
					...
					'fields'    => apply_filters(
						...
						[
							[
								...
								'desc' => __( 'By default, the gateway for this form will inherit the global default gateway (set under Best Donation > Settings > Payment Gateways). This option allows you to customize the default gateway for this form only.', 'give' ),
							...
							[
								...
								'type'  => 'docs_link',
								'url'   => 'http://docs.Best Donation.com/form-display-options',
					...
					'fields'    => apply_filters(
						...
						[
							...
							[
								...
								'type'  => 'docs_link',
								'url'   => 'http://docs.Best Donation.com/form-donation-goal',
								'title' => __( 'Donation Goal', 'give' ),
							],
						],
						$post_id
					...
					'fields'    => apply_filters(
						...
						[
							...
							[
								'name'  => 'terms_docs',
								'type'  => 'docs_link',
								'url'   => 'http://docs.Best Donation.com/form-terms',
