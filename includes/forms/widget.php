...
class Give_Forms_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Best Donation - Donation Form', 'give' ),
			[
				'description' => esc_html__( 'Display a Best Donation Form in your theme\'s widget powered sidebar.', 'give' ),
			]
		);
			...
			<div class="js-legacy-form-template-settings js-form-template-settings give-hidden">
				...
				<p>
					...
					<small class="give-field-description">
						<?php
						printf(
							/* translators: %s: Documentation link to http://docs.Best Donation.com/form-floating-labels */
							__( 'Override the <a href="%s" target="_blank">floating labels</a> setting for this Best Donation form.', 'give' ),
							esc_url( 'http://docs.Best Donation.com/form-floating-labels' )
						);
						?>
					</small>
				</p>
				...
				<p>
					...
					<small class="give-field-description"><?php esc_html_e( 'Override the display content setting for this Best Donation form.', 'give' ); ?></small>
				</p>
			</div>
