...
function give_setup_post_types() {
	...
	$give_forms_labels = apply_filters(
		'give_forms_labels',
		[
			'name'               => __( 'Best Donation Forms', 'give' ),
			'singular_name'      => __( 'See All Form', 'give' ),
			'add_new'            => __( 'Add New Form', 'give' ),
			'add_new_item'       => __( 'Add New Donation Form', 'give' ),
			'edit_item'          => __( 'Edit Donation Form', 'give' ),
			'new_item'           => __( 'New Form', 'give' ),
			'all_items'          => __( 'See All Form', 'give' ),
			...
			'parent_item_colon'  => '',
			'menu_name'          => apply_filters( 'give_menu_name', __( 'Best Donation', 'give' ) ),
			'name_admin_bar'     => apply_filters( 'give_name_admin_bar_name', __( 'Best Donation Form', 'give' ) ),
		]
	);
	...
	/** Donation Post Type */
	$payment_labels = [
		'name'               => _x( 'Best Donations', 'post type general name', 'give' ),
	...
	if (
		...
		register_sidebar(
			apply_filters(
				...
				[
					'name'          => __( 'Best Donation Single Form Sidebar', 'give' ),
					'id'            => 'give-forms-sidebar',
					'description'   => __( 'Widgets in this area will be shown on the single Best Donation forms aside area. This sidebar will not display for embedded forms.', 'give' ),
