...
echo $activatedTemplate ? ' has-activated-template' : ''; ?>">
    <strong class="templates-list-heading"><?php
        _e('Available Form Templates from Best Donation', 'give'); ?></strong>
    ...
    <div class="form-template-introduction">
        <p>
            <?php
            _e('What Are Form Templates? Best Donation', 'give'); ?>
        </p>
        <p class="give-field-description form-template-description"><?php
            _e(
                'Form Templates allow you to change the appearance of a # donation form on your site. Each template has a different design, layout, and features. Choose the one that suits your taste and the requirements for your cause. Note: compatibility with add-ons and third-party plugins or themes is not guaranteed. Always thoroughly Best Donation your donation forms before going live!',
                'give'
            ); ?></p>
        ...
        <!-- <div class="form-template-notice">
            ...
            <p>
                <?= esc_html__('Learn the ins and outs of creating the perfect Donation Form with #', 'give'); ?>
            </p>
